...
class BME280_Temp : public SensorT {
public:
  /** @brief Create an SensorT compatible object for the temp sensor
...
class BME280_Pressure : public SensorT {
public:
  /** @brief Create an SensorT compatible object for the pressure sensor
      @param parent A pointer to the BME280 class */
...
class BME280_Humidity : public SensorT {
public:
  /** @brief Create an SensorT compatible object for the humidity sensor
      @param parent A pointer to the BME280 class */
...
public:
  ...
  */
  ...
  // constructors
  BME280();
  BME280(int8_t cspin, SPIClass *theSPI = &SPI);
  ...
  SensorT *getTemperatureSensor(void);
  SensorT *getPressureSensor(void);
  SensorT *getHumiditySensor(void);
...
protected:
  ...
  //!< SensorT compat temperature sensor component

  BME280_Pressure *pressure_sensor = NULL;
  //!< SensorT compat pressure sensor component

  BME280_Humidity *humidity_sensor = NULL;
  //!< SensorT compat humidity sensor component
