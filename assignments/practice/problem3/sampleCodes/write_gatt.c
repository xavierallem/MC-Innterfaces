...
*
* gcc write_gatt.c `pkg-config --cflags glib-2.0 gio-2.0` -Wall -Wextra -o write_gatt `pkg-config --libs glib-2.0 gio-2.0`
*
*/
...
int main(int argc, char **argv)
{
	...
	rc = bluez_gatt_method("WriteValue");

        if(rc) {
        g_print("Not able to write\n");
        goto fail;
    	}
