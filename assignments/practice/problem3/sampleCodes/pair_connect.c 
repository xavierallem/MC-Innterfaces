/*
@file           pair_connect.c 
@description    Pair and connect a blutooth device   
 ...
 *
 * gcc pair_connect.c `pkg-config --cflags glib-2.0 gio-2.0` -Wall -Wextra -o ./pair_connect `pkg-config --libs glib-2.0 gio-2.0`
 */
#include <glib.h>
#include <gio/gio.h>
#include <signal.h>
